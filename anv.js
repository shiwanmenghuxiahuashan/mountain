 ...
 void function(win) {
    ...
    // 主函数
    ANV.analytics = function(options) {
        if (typeof options !== 'object') {
            throw('ANV.analytics need a argument at least.');
        }
    ...
    // 赋值版本号
    ANV.analytics.version = VERSION;

    // 挂载私有方法
    ANV.analytics._tool = tool;
    ANV.analytics._engine = engine;
    ...
    tool.getId = function() {
        ...
        return 'ANV' + getIdItem() + getIdItem() + getIdItem();
    };
